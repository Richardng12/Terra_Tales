...
namespace MoreMountains.CorgiEngine
{
    ...
    public class CharacterSwitchManager : MonoBehaviour
    {
        ...
        protected virtual void SwitchCharacter()
        {
            ...
            if (CommonHealth)
            {
                _instantiatedCharacters[CurrentIndex].gameObject.GetComponentNoAlloc<Health>().CurrentHealth = LevelManager.Instance.Players[0].gameObject.GetComponentNoAlloc<Health>().CurrentHealth;
            }
