...
{	
	...
	public class CharacterWallClinging : CharacterAbility 
	{
        ...
        protected virtual void EnterWallClinging()
        {
            ...
            {
                _wallClingingOverride = _controller.CurrentWallCollider.gameObject.GetComponentNoAlloc<WallClingingOverride>();
            }
            else if (_raycast.collider != null)
            {
                _wallClingingOverride = _raycast.collider.gameObject.GetComponentNoAlloc<WallClingingOverride>();
            }
