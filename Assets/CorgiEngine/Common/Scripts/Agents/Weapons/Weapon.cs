	...
	public class Weapon : MonoBehaviour 
	{
        ...
        public virtual void InitializeAnimatorParameters()
        {
            ...
            for (int i = 0; i < Animators.Count; i++)
            {
                ...
                MMAnimator.AddAnimatorParamaterIfExists(Animators[i], "Alive", AnimatorControllerParameterType.Bool, _animatorParameters[i]);
            }
		...
		public virtual void UpdateAnimator()
        {
            for (int i = 0; i < Animators.Count; i++)
            {
                ...
                if (Owner != null)
                {
                    MMAnimator.UpdateAnimatorBool(Animators[i], "Alive", (Owner.ConditionState.CurrentState != CharacterStates.CharacterConditions.Dead), _animatorParameters[i]);
                }                
